...
namespace Player
{
    public class PlayerNetworkManager : NetworkBehaviour
    {
        ...
        public static void AddPlayer(PlayerNetworkEntityModel playerNetworkEntityModel) => Instance.Players.Add(playerNetworkEntityModel);
        
        public static void RemovePlayer(PlayerNetworkEntityModel playerNetworkEntityModel) => Instance.Players.Remove(playerNetworkEntityModel);

        public static PlayerNetworkEntityModel GetPlayer(PlayerRef playerRef) => Instance.Players.FirstOrDefault(player => player.NetworkPlayerRef.PlayerId == playerRef.PlayerId);
        
        public static PlayerNetworkEntityModel GetLocalPlayer() => Instance.Players.FirstOrDefault(player => !player.IsEnemy);
        
        public static PlayerNetworkEntityModel GetEnemy() => Instance.Players.FirstOrDefault(player => player.IsEnemy);
